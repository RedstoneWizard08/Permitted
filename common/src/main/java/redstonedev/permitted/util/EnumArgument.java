/**
 * From: https://github.com/Fabricators-of-Create/Porting-Lib/blob/1.20.1/modules/base/src/main/java/io/github/fabricators_of_create/porting_lib/command/EnumArgument.java
 */
...
public class EnumArgument<T extends Enum<T>> implements ArgumentType<T> {
    private static final Dynamic2CommandExceptionType INVALID_ENUM = new Dynamic2CommandExceptionType(
            (found, constants) -> Component.translatable("commands.porting_lib.arguments.enum.invalid", constants,
                    found));
